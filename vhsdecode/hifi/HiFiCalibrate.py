...
def main() -> int:
    ...
    * Possibly export to cli parameters for hifi-decode
    ...
    param_dict = {
        'expander_attack_tau': {'min':0.001,'max':0.01,'step':1e-4},
        ...
        'expander_weighting_low_pass': {'min':5000,'max':20000,'step':500},
        'expander_weighting_low_pass_transition': {'min':5000,'max':200000,'step':200},
