...
def main() -> int:
    ...
    * Possibly export to cli parameters for hifi-decode
    ...
    param_dict = {
        'expander_attack_tau': {'min':0.002,'max':0.01,'step':1e-3},
        ...
        'expander_weighting_low_pass': {'min':3000,'max':20000,'step':1000},
        'expander_weighting_low_pass_transition': {'min':2000,'max':200000,'step':1000},
