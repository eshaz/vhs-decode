...
DEFAULT_VHS_EXPANDER_WEIGHTING_LOW_PASS = 21000
DEFAULT_VHS_EXPANDER_WEIGHTING_LOW_PASS_TRANSITION = 40000

DEFAULT_8MM_EXPANDER_WEIGHTING_TAU_1 = 75e-6
DEFAULT_8MM_EXPANDER_WEIGHTING_TAU_2 = 27e-6
DEFAULT_8MM_EXPANDER_WEIGHTING_LOW_PASS = 21000
DEFAULT_8MM_EXPANDER_WEIGHTING_LOW_PASS_TRANSITION = 40000
...
class Expander:
    def __init__(
        ...
        self.lowpass_iirb, self.lowpass_iira = firdes_lowpass(
            self.audio_rate,
            min(weighting_low_pass, self.audio_rate / 2 - 1),
